...
class TestMarkdownStatsWriter:
    @pytest.fixture
    def markdown_stats_writer(self) -> MarkdownStatsWriter:
        """Fixture to create a new MarkdownStatsWriter instance for each test"""
        ...
        return MarkdownStatsWriter(mock_stats_data, "tests/mock_output/data")

    def test_correct_output_in_file(self, markdown_stats_writer: MarkdownStatsWriter):
        markdown_stats_writer.write_stats_to_file()

        modified_file_path: Path = markdown_stats_writer._file_path
