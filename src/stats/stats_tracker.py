...
class StatsTracker:
    ...
    def update_stats(
        ...
        for log in logs_generator:
            ...
            self._total_response_size += log.body_bytes_sent
    ...
    def get_stats_data(self) -> StatsData:
        ...
        most_frequent_sources = self._get_most_frequent_sources()
        most_frequent_status_codes = self._get_most_frequent_status_codes()
        avg_response_size = self._get_avg_response_size()
        percentile_95 = self._get_percentile_95th_response_size()
